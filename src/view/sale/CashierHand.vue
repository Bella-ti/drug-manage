  ...
  <div>
    <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>收银员交接班</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
